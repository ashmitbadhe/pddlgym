...
for env_name, kwargs in [
        ("perestroika", {'operators_as_actions' : True, 'render' : perestroika_render, 'dynamic_action_space' : True}),
        ("auv", {'operators_as_actions' : True, 'render' : auv_render, 'dynamic_action_space' : True}),
