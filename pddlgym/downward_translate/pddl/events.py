...
class Event:
    ...
    def relaxed(self):
        ...
        return Event(self.name, self.parameters, self.num_external_parameters,
    ...
    def instantiate(self, var_mapping, init_facts, init_assignments,
        ...
        if effects:
            if metric:
                ...
                cost = 1
            return PropositionalEvent(name, precondition, effects, cost)
        else:
            return None


class PropositionalEvent:
    ...
    def __repr__(self):
        return "<PropositionalEvent %r at %#x>" % (self.name, id(self))
