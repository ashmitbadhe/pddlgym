(define (problem AUV-problem-20x20-1)
(:domain AUV)
(:objects
...
r1 r2 r3 r4 r5 r6 r7 r8 r9 r10 - resource
a - auv
s1 s2 s3 s4 s5 s6 s7 s8 - ship
)
(:init
(operational a)
(at a l-1-1)
...
(connected-ship s1 l-3-5 l-3-6)
(connected-ship s1 l-3-6 l-3-7)
(connected-ship s1 l-3-7 l-3-8)
(connected-ship s1 l-3-8 l-3-9)
(connected-ship s1 l-3-9 l-3-10)
(connected-ship s1 l-3-10 l-3-11)
(connected-ship s1 l-3-11 l-3-12)
(connected-ship s1 l-3-12 l-3-13)
(connected-ship s1 l-3-13 l-3-14)
(connected-ship s1 l-3-14 l-3-15)
(connected-ship s1 l-3-15 l-3-16)
(connected-ship s1 l-3-16 l-3-17)
(connected-ship s1 l-3-17 l-3-18)
(connected-ship s1 l-3-18 l-3-19)
(connected-ship s1 l-3-19 l-3-20)
(outside s1)
(entry s2 l-5-20)
(exit s2 l-5-1)
(connected-ship s2 l-5-20 l-5-19)
(connected-ship s2 l-5-19 l-5-18)
(connected-ship s2 l-5-18 l-5-17)
(connected-ship s2 l-5-17 l-5-16)
(connected-ship s2 l-5-16 l-5-15)
(connected-ship s2 l-5-15 l-5-14)
(connected-ship s2 l-5-14 l-5-13)
(connected-ship s2 l-5-13 l-5-12)
(connected-ship s2 l-5-12 l-5-11)
(connected-ship s2 l-5-11 l-5-10)
(connected-ship s2 l-5-10 l-5-9)
(connected-ship s2 l-5-9 l-5-8)
(connected-ship s2 l-5-8 l-5-7)
...
(entry s3 l-6-20)
(exit s3 l-6-1)
(connected-ship s3 l-6-20 l-6-19)
(connected-ship s3 l-6-19 l-6-18)
(connected-ship s3 l-6-18 l-6-17)
(connected-ship s3 l-6-17 l-6-16)
(connected-ship s3 l-6-16 l-6-15)
(connected-ship s3 l-6-15 l-6-14)
(connected-ship s3 l-6-14 l-6-13)
(connected-ship s3 l-6-13 l-6-12)
(connected-ship s3 l-6-12 l-6-11)
(connected-ship s3 l-6-11 l-6-10)
(connected-ship s3 l-6-10 l-6-9)
(connected-ship s3 l-6-9 l-6-8)
(connected-ship s3 l-6-8 l-6-7)
(connected-ship s3 l-6-7 l-6-6)
...
(entry s4 l-8-1)
(exit s4 l-8-20)
(connected-ship s4 l-8-1 l-8-2)
(connected-ship s4 l-8-2 l-8-3)
(connected-ship s4 l-8-3 l-8-4)
(connected-ship s4 l-8-4 l-8-5)
(connected-ship s4 l-8-5 l-8-6)
(connected-ship s4 l-8-6 l-8-7)
(connected-ship s4 l-8-7 l-8-8)
(connected-ship s4 l-8-8 l-8-9)
(connected-ship s4 l-8-9 l-8-10)
(connected-ship s4 l-8-10 l-8-11)
(connected-ship s4 l-8-11 l-8-12)
(connected-ship s4 l-8-12 l-8-13)
(connected-ship s4 l-8-13 l-8-14)
(connected-ship s4 l-8-14 l-8-15)
(connected-ship s4 l-8-15 l-8-16)
(connected-ship s4 l-8-16 l-8-17)
(connected-ship s4 l-8-17 l-8-18)
(connected-ship s4 l-8-18 l-8-19)
(connected-ship s4 l-8-19 l-8-20)
(outside s4)
(entry s5 l-9-1)
(exit s5 l-9-20)
(connected-ship s5 l-9-1 l-9-2)
(connected-ship s5 l-9-2 l-9-3)
(connected-ship s5 l-9-3 l-9-4)
(connected-ship s5 l-9-4 l-9-5)
(connected-ship s5 l-9-5 l-9-6)
(connected-ship s5 l-9-6 l-9-7)
(connected-ship s5 l-9-7 l-9-8)
(connected-ship s5 l-9-8 l-9-9)
(connected-ship s5 l-9-9 l-9-10)
(connected-ship s5 l-9-10 l-9-11)
(connected-ship s5 l-9-11 l-9-12)
(connected-ship s5 l-9-12 l-9-13)
(connected-ship s5 l-9-13 l-9-14)
(connected-ship s5 l-9-14 l-9-15)
(connected-ship s5 l-9-15 l-9-16)
(connected-ship s5 l-9-16 l-9-17)
(connected-ship s5 l-9-17 l-9-18)
(connected-ship s5 l-9-18 l-9-19)
(connected-ship s5 l-9-19 l-9-20)
(outside s5)
(entry s6 l-10-1)
(exit s6 l-10-20)
(connected-ship s6 l-10-1 l-10-2)
(connected-ship s6 l-10-2 l-10-3)
(connected-ship s6 l-10-3 l-10-4)
(connected-ship s6 l-10-4 l-10-5)
...
(connected-ship s6 l-10-10 l-10-11)
(connected-ship s6 l-10-11 l-10-12)
(connected-ship s6 l-10-12 l-10-13)
(connected-ship s6 l-10-13 l-10-14)
(connected-ship s6 l-10-14 l-10-15)
(connected-ship s6 l-10-15 l-10-16)
(connected-ship s6 l-10-16 l-10-17)
(connected-ship s6 l-10-17 l-10-18)
(connected-ship s6 l-10-18 l-10-19)
(connected-ship s6 l-10-19 l-10-20)
(outside s6)
(entry s7 l-19-1)
(exit s7 l-19-20)
(connected-ship s7 l-19-1 l-19-2)
(connected-ship s7 l-19-2 l-19-3)
(connected-ship s7 l-19-3 l-19-4)
(connected-ship s7 l-19-4 l-19-5)
(connected-ship s7 l-19-5 l-19-6)
(connected-ship s7 l-19-6 l-19-7)
(connected-ship s7 l-19-7 l-19-8)
(connected-ship s7 l-19-8 l-19-9)
(connected-ship s7 l-19-9 l-19-10)
(connected-ship s7 l-19-10 l-19-11)
(connected-ship s7 l-19-11 l-19-12)
(connected-ship s7 l-19-12 l-19-13)
(connected-ship s7 l-19-13 l-19-14)
(connected-ship s7 l-19-14 l-19-15)
(connected-ship s7 l-19-15 l-19-16)
(connected-ship s7 l-19-16 l-19-17)
(connected-ship s7 l-19-17 l-19-18)
(connected-ship s7 l-19-18 l-19-19)
(connected-ship s7 l-19-19 l-19-20)
(outside s7)
(entry s8 l-20-1)
(exit s8 l-20-20)
(connected-ship s8 l-20-1 l-20-2)
(connected-ship s8 l-20-2 l-20-3)
(connected-ship s8 l-20-3 l-20-4)
(connected-ship s8 l-20-4 l-20-5)
(connected-ship s8 l-20-5 l-20-6)
(connected-ship s8 l-20-6 l-20-7)
(connected-ship s8 l-20-7 l-20-8)
(connected-ship s8 l-20-8 l-20-9)
(connected-ship s8 l-20-9 l-20-10)
(connected-ship s8 l-20-10 l-20-11)
(connected-ship s8 l-20-11 l-20-12)
(connected-ship s8 l-20-12 l-20-13)
(connected-ship s8 l-20-13 l-20-14)
(connected-ship s8 l-20-14 l-20-15)
(connected-ship s8 l-20-15 l-20-16)
(connected-ship s8 l-20-16 l-20-17)
(connected-ship s8 l-20-17 l-20-18)
(connected-ship s8 l-20-18 l-20-19)
(connected-ship s8 l-20-19 l-20-20)
(outside s8)
(free l-2-1)
(free l-3-1)
(free l-4-1)
