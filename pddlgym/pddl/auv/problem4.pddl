(define (problem AUV-problem-10x10-1)
(:domain AUV)
(:objects
...
(entry s1 l-2-10)
(exit s1 l-2-1)
(connected-ship s1 l-2-10 l-2-9)
(connected-ship s1 l-2-9 l-2-8)
(connected-ship s1 l-2-8 l-2-7)
(connected-ship s1 l-2-7 l-2-6)
...
(entry s2 l-6-1)
(exit s2 l-6-10)
(connected-ship s2 l-6-1 l-6-2)
(connected-ship s2 l-6-2 l-6-3)
(connected-ship s2 l-6-3 l-6-4)
(connected-ship s2 l-6-4 l-6-5)
(connected-ship s2 l-6-5 l-6-6)
(connected-ship s2 l-6-6 l-6-7)
(connected-ship s2 l-6-7 l-6-8)
(connected-ship s2 l-6-8 l-6-9)
(connected-ship s2 l-6-9 l-6-10)
(outside s2)
(entry s3 l-7-10)
(exit s3 l-7-1)
(connected-ship s3 l-7-10 l-7-9)
(connected-ship s3 l-7-9 l-7-8)
(connected-ship s3 l-7-8 l-7-7)
(connected-ship s3 l-7-7 l-7-6)
(connected-ship s3 l-7-6 l-7-5)
(connected-ship s3 l-7-5 l-7-4)
(connected-ship s3 l-7-4 l-7-3)
(connected-ship s3 l-7-3 l-7-2)
(connected-ship s3 l-7-2 l-7-1)
(outside s3)
(entry s4 l-8-10)
(exit s4 l-8-1)
(connected-ship s4 l-8-10 l-8-9)
(connected-ship s4 l-8-9 l-8-8)
(connected-ship s4 l-8-8 l-8-7)
(connected-ship s4 l-8-7 l-8-6)
(connected-ship s4 l-8-6 l-8-5)
(connected-ship s4 l-8-5 l-8-4)
(connected-ship s4 l-8-4 l-8-3)
(connected-ship s4 l-8-3 l-8-2)
(connected-ship s4 l-8-2 l-8-1)
(outside s4)
(entry s5 l-9-1)
(exit s5 l-9-10)
