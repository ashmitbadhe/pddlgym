...
(entry s2 l-3-5)
(exit s2 l-3-1)
(connected-ship s2 l-3-5 l-3-4)
(connected-ship s2 l-3-4 l-3-3)
(connected-ship s2 l-3-3 l-3-2)
(connected-ship s2 l-3-2 l-3-1)
(outside s2)
(entry s3 l-4-5)
(exit s3 l-4-1)
(connected-ship s3 l-4-5 l-4-4)
(connected-ship s3 l-4-4 l-4-3)
(connected-ship s3 l-4-3 l-4-2)
(connected-ship s3 l-4-2 l-4-1)
(outside s3)
(free l-2-1)
(free l-3-1)
(free l-4-1)
